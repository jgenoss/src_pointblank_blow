...
BOOL	CCapsuleItem::Create( UINT32 ui32ItemID, INT32 i32ProbCount, INT32 i32ItemCount, const char* szName )
{
	m_ui32ItemID				= ui32ItemID;
	...
	i3String::Copy( m_szName, szName, MAX_PATH );
