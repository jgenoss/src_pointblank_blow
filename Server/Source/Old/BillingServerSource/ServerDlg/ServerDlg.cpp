// AuthDlg.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CServerDlgApp, CWinApp)
...
// 유일한 CServerDlgApp 개체입니다.

CServerDlgApp theApp;


// CServerDlgApp 초기화

BOOL CServerDlgApp::InitInstance()
{
