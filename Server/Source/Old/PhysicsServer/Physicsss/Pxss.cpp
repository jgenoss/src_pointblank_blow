...
{	
	...
	strcpy(pServiceName,"PBPhysicsService");
	...
	{
		printf("Physics Server Help!\n\n"); 
		printf("PBPxs.exe -i : Service Install \n"); 
		printf("PBPxs.exe -u : Service Uninstall. \n"); 
		printf("PBPxs.exe -s : Service Start. \n");
		printf("PBPxs.exe -e : Service End. \n");
		printf("PBPxs.exe : It does not use. \n");
	}
...
void Install(char* pPath, char* pName)
{
	...
	else
	{
		...
		else
		{
			...
			i3String::Copy( Des, "Point Blank Physics Server", MAX_STRING_COUNT );
