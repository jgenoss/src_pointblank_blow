#ifndef __LOGIN_WORKER_VIETNAM_H__
#define __LOGIN_WORKER_VIETNAM_H__
...
class CLoginWorker_Vietnam : public CLoginBase
{
...
public:
	CLoginWorker_Vietnam();
	virtual ~CLoginWorker_Vietnam();
};

#endif // __LOGIN_WORKER_VIETNAM_H__