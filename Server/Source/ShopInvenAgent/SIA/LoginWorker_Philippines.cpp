...
#define TOKEN_RSA_PUB_KEY_FILE_PHILIPPINES			"publickey.pem"

CLoginWorker_Philippines::CLoginWorker_Philippines()
{
}
...
BOOL CLoginWorker_Philippines::_Create()
{
	char strKeyFile[MAX_PATH];
	i3String::Format( strKeyFile, MAX_PATH, "%s\\%s", g_strCCurrentPath, TOKEN_RSA_PUB_KEY_FILE_PHILIPPINES );

	if( false == m_OpensslRSA.Init( strKeyFile ) )					return FALSE;

	g_pLog->WriteLog( WARNING_TYPE_NORMAL, WARNING_NO, L"[LOAD] CLoginWorker_PH_Garena Create Success - Check Key File" ); 

	return TRUE;
}

void CLoginWorker_Philippines::_Destroy()
{
}

BOOL CLoginWorker_Philippines::_WorkProcess( LOGIN_INPUT* pInput, LOGIN_OUTPUT* pOutput )
{
	...
	case TYPE_LOGIN_ID		:
		{
			...
			//g_pLog->WriteLog( WARNING_TYPE_NORMAL, WARNING_AUTH, "Login........" ); 
...
BOOL CLoginWorker_Philippines::_DecryptSessionKey( LOGIN_INPUT* pInput, LOGIN_OUTPUT* pOutput )
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
	UserTokInfoPhilippines_t tokInfo;
