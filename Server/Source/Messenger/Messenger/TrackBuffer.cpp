...
BOOL CTrackBuffer::Create(UINT32 ui32BufferSize,UINT32 ui32DataSize,UINT32 ui32MaxIdx)
{
...
BOOL CTrackBuffer::Push(UINT8* pui8Data,UINT32 ui32DataSize)
{
	...
	UINT32 ui32Count = m_ui32idxWrite - m_ui32idxRead;
