#ifndef __i3_RING_BUFFER_H__
#define __i3_RING_BUFFER_H__
...
class I3_EXPORT_BASE i3RingBuffer : public i3ElementBase
{
	I3_CLASS_DEFINE( i3RingBuffer );
