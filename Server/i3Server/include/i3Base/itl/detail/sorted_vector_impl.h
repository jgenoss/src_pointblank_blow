...
namespace i3
{
	namespace detail
	{
		...
		struct sorted_vector_compare< i3::pair<const Key, Val>, Pred> : public Pred
		{
			typedef i3::pair<const Key, Val>								value_type;
	...
	template<class Key, class Val, class Pred>
	class sorted_vector_key< i3::pair<const Key, Val>, Pred> : protected i3::enable_ebo< detail::sorted_vector_compare<i3::pair<const Key, Val>, Pred> >
	{
	protected:
		typedef			sorted_vector_key<i3::pair<const Key, Val>, Pred>	my_type;
		typedef			i3::enable_ebo< detail::sorted_vector_compare<i3::pair<const Key, Val>, Pred> >	base_type;
		typedef			i3::pair<const Key, Val>														value_type;
