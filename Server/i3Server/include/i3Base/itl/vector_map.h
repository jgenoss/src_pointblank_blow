...
namespace i3
{
	...
	class vector_map : public sorted_vector< i3::pair<const Key, T>, Pr, Alloc >
	{	
	public:
		typedef vector_map<Key, T, Pr, Alloc>							my_type;
		typedef sorted_vector< i3::pair<const Key, T>, Pr, Alloc  >		base_type;
	...
	template<class Key,	class T, class Pr = less<Key>, class Alloc = i3::pool_allocator< i3::pair<const Key, T> > >
	class vector_multimap	: public multi_sorted_vector< i3::pair<const Key, T>, Pr, Alloc  >
	{	
	public:
		typedef vector_multimap<Key, T, Pr, Alloc>						my_type;
		typedef multi_sorted_vector<i3::pair<const Key, T>, Pr, Alloc > base_type;
