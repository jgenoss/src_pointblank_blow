...
I3_CLASS_INSTANCE( i3TimeEventInfo, i3NamedElement);
...
void i3TimeEventInfo::CopyTo( i3ElementBase * pDest, I3_COPY_METHOD method)
{
	...
	{
		i3Action * pDestAction = (i3Action*)CREATEINSTANCE( pAction->GetMeta());
...
typedef struct _tagi3PersistTimeEventInfo
{
	UINT8		m_ID[4];
	UINT32		m_State;
	REAL32		m_Time;
