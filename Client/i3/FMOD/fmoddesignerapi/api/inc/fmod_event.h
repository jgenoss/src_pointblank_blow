...
#define FMOD_EVENT_VERSION 0x00010804
...
typedef enum
{
    ...
    FMOD_EVENTPROPERTY_PITCH,                 /* Type : float     - Relative pitch of event. */
    FMOD_EVENTPROPERTY_PITCHRANDOMIZATION,    /* Type : float     - Random deviation in pitch of event. */
    ...
    FMOD_EVENTPROPERTY_3D_MAXDISTANCE,        /* Type : float     - Maximum 3d distance of event.  Means different things depending on EVENTPROPERTY_3D_ROLLOFF. */
...
[
    ...
    the FMOD_EVENT_CALLBACKTYPE_STOLEN.<br>
    <br>
...
typedef struct FMOD_EVENT_SYSTEMINFO
{
    ...
    int                      numplayingevents; /* [in/out] On entry, maximum number of entries in playingevents array. On exit, actual number of entries in playingevents array. Optional. Must be used in conjunction with playingevents. */
...
FMOD_RESULT F_API FMOD_EventSystem_Load              (FMOD_EVENTSYSTEM *eventsystem, const char *filename, FMOD_EVENT_LOADINFO *loadinfo, FMOD_EVENTPROJECT **project);
...
FMOD_RESULT F_API FMOD_EventCategory_SetPitch        (FMOD_EVENTCATEGORY *eventcategory, float pitch);
FMOD_RESULT F_API FMOD_EventCategory_GetPitch        (FMOD_EVENTCATEGORY *eventcategory, float *pitch);
...
FMOD_RESULT F_API FMOD_Event_SetPitch                (FMOD_EVENT *event, float pitch);
FMOD_RESULT F_API FMOD_Event_GetPitch                (FMOD_EVENT *event, float *pitch);
