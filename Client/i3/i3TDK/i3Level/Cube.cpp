...
void CCube::GetPlaneXYZAxis(D3DXPLANE* pXplane, D3DXPLANE* pYplane, D3DXPLANE* pZplane)
{
	...
	D3DXVECTOR3 temp = (dxv3Center + dxv3Ynormal);
	D3DXVECTOR3 temp2 = (dxv3Center + dxv3Znormal);

	D3DXPlaneFromPoints(pXplane, &dxv3Center, &temp, &temp2);

	temp = (dxv3Center + dxv3Xnormal);
	temp2 = (dxv3Center + dxv3Znormal);
	D3DXPlaneFromPoints(pYplane, &dxv3Center, &temp, &temp2);

	temp = (dxv3Center + dxv3Xnormal);
	temp2 = (dxv3Center + dxv3Ynormal);
	D3DXPlaneFromPoints(pZplane, &dxv3Center, &temp, &temp2);
}
