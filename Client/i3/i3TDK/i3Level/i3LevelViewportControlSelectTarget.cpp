...
I3_CLASS_INSTANCE( i3LevelViewportControlSelectTarget);

void i3LevelViewportControlSelectTarget::Create(void)
{
	m_hCursor = ::LoadCursor( g_hInstTDK, MAKEINTRESOURCE( IDC_LV_SELECT_TARGET));
}

void i3LevelViewportControlSelectTarget::DrawSelectRect( I3_LEVEL_EDIT_CONTEXT * pCtx, POINT pt)
{
	HDC dc;
	CRect rect;
...
void i3LevelViewportControlSelectTarget::BeginMultiSelect( I3_LEVEL_EDIT_CONTEXT * pCtx, POINT pt)
{
...
void i3LevelViewportControlSelectTarget::MultiSelecting( I3_LEVEL_EDIT_CONTEXT * pCtx, POINT pt)
{
...
void i3LevelViewportControlSelectTarget::EndMultiSelect( I3_LEVEL_EDIT_CONTEXT * pCtx, POINT pt)
{
...
bool i3LevelViewportControlSelectTarget::OnLButtonDown( I3_LEVEL_EDIT_CONTEXT * pCtx, UINT nFlags, CPoint point)
{
...
bool i3LevelViewportControlSelectTarget::OnLButtonUp( I3_LEVEL_EDIT_CONTEXT * pCtx, UINT nFlags, CPoint point)
{
	i3LevelViewport * pViewport = pCtx->m_pViewport;
...
bool i3LevelViewportControlSelectTarget::OnMouseMove( I3_LEVEL_EDIT_CONTEXT * pCtx, UINT nFlags, CPoint point)
{
	if( pCtx->m_bDragging)
	{
...
bool i3LevelViewportControlSelectTarget::OnRButtonDown( I3_LEVEL_EDIT_CONTEXT * pCtx, UINT nFlags, CPoint point)
{
	i3LevelViewport * pViewport = pCtx->m_pViewport;
	i3LevelFramework * pFramework = pViewport->getFramework();
