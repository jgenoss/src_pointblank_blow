========================================================================
    STATIC LIBRARY : i3Level Project Overview
========================================================================

AppWizard has created this i3Level library project for you. 
This file contains a summary of what you will find in each of the files that
make up your i3Level application.
...
StdAfx.h, StdAfx.cpp
    ...
    named i3Level.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "i3Level.rc" and a "i3Level.h" that 
