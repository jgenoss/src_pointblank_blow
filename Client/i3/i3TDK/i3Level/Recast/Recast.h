...
//extern "C" void calcTriNormal(const float* v0, const float* v1, const float* v2, float* norm);
...
/// @ingroup recast
struct I3_EXPORT_TDK rcPolyMesh
{
...
/// @ingroup recast
struct I3_EXPORT_TDK rcPolyMeshDetail
{
