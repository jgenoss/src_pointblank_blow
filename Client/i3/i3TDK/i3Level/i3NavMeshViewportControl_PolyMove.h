...
class I3_EXPORT_TDK i3NavMeshViewportControl_PolyMove : public i3LevelViewportControl
{
	I3_EXPORT_CLASS_DEFINE( i3NavMeshViewportControl_PolyMove, i3LevelViewportControl );
