...
void *	i3StackMemoryPool::Alloc( UINT32 sz)
{
	...
	{
		Dump();
		I3PRINTLOG(I3LOG_FATAL,  "Memory Overflow!!! : Maximum %d bytes", m_MaxSize);
		return nullptr;
	}
#endif
...
void	i3StackMemoryPool::Dump(void)
{
	...
	i3::integral_to_comma_str( m_MaxSize, szMax, sizeof(szMax));
	i3::integral_to_comma_str( m_AllocedSize, szAlloc, sizeof(szAlloc));
	i3::integral_to_comma_str( m_pTail - m_pBuff, szUsed, sizeof(szUsed));
