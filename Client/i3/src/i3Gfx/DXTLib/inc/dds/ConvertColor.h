...
public:
    ...
    {
        r = (int)UnsignedToFloat((int)fp.r);
        g = (int)UnsignedToFloat((int)fp.g);
        b = (int)UnsignedToFloat((int)fp.b);
        a = (int)UnsignedToFloat((int)fp.a);
    }
    ...
    {
        outColor.r = (unsigned char)FloatToUnsigned(inColor.r);
        outColor.g = (unsigned char)FloatToUnsigned(inColor.g);
        outColor.b = (unsigned char)FloatToUnsigned(inColor.b);
        outColor.a = (unsigned char)FloatToUnsigned(inColor.a);
