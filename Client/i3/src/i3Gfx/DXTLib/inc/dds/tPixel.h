...
public:
    ...
    {
        r = (unsigned char)(Clamp((int)((int)r + (int)v.r), 0, 255));
        g = (unsigned char)(Clamp((int)g + (int)v.g, 0, 255));
        b = (unsigned char)(Clamp((int)b + (int)v.b, 0, 255));
        a = (unsigned char)(Clamp((int)a + (int)v.a, 0, 255));
    ...
    {
        return rgba_t( (unsigned char)(v.r/s), (unsigned char)(v.g/s), (unsigned char)(v.b/s), (unsigned char)(v.a/s));
    }
...
public:
    ...
    {
        r = (unsigned short)(Clamp((int)r + (int)v.r, 0, 65535));   
        g = (unsigned short)(Clamp((int)g + (int)v.g, 0, 65535));   
        b = (unsigned short)(Clamp((int)b + (int)v.b, 0, 65535));   
        a = (unsigned short)(Clamp((int)a + (int)v.a, 0, 65535));   
    ...
    friend rgba16_t operator + (const rgba16_t & v1, const rgba16_t& v2)
    {
        ...
        return rgba16_t( (unsigned short)r, (unsigned short)g, (unsigned short)b, (unsigned short)a);
    }

    friend rgba16_t operator / (const rgba16_t& v, float s)
    {
        return rgba16_t( (unsigned short)(v.r/s), (unsigned short)(v.g/s), (unsigned short)(v.b/s), (unsigned short)(v.a/s));
    }
