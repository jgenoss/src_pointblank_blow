...
I3_CLASS_INSTANCE( i3UITemplate_ProgressBar);

i3UIShape* i3UITemplate_ProgressBar::getShape(INT32 nIndex)	
{
	I3_BOUNDCHK( nIndex, getShapeCount());
	return &m_pShape[nIndex];
}

const char * i3UITemplate_ProgressBar::getShapeInfoString(INT32 nIndex)
{
	I3_BOUNDCHK( nIndex, getShapeCount());
	return s_pszProgressBarInfoString[nIndex];
}

const char * i3UITemplate_ProgressBar::getComment(void)
{
	return "Progress Bar(Comment)";
}

const char * i3UITemplate_ProgressBar::getTemplateName(void)
{
	return "Progress Bar";
}

I3UI_CATEGORY  i3UITemplate_ProgressBar::getTemplateCategory(void)
{
	return I3UI_CATEGORY_PROGRESS;
}

bool i3UITemplate_ProgressBar::GetControlRect( i3::pack::RECT * pRect)
{
	...
	m_rHeight = getShape(I3UI_PROGRESSBAR_SHAPE_CENTER)->getHeight() - getShape(I3UI_PROGRESSBAR_SHAPE_BAR)->getHeight();
...
void i3UITemplate_ProgressBar::InitializeLayout(void)
{
	AdjustLayout( 200.0f, 50.0f);
}

bool i3UITemplate_ProgressBar::AdjustLayout(REAL32 cx, REAL32 cy, i3::pack::RECT * pRects, INT32 shapeCount)
{
	...
	pBar->top = pCenter->top + m_rHeight;
	pBar->bottom = pCenter->bottom - m_rHeight;

	return true;
}

i3ClassMeta	* i3UITemplate_ProgressBar::GetInstanceMeta()
{
	return i3UIProgressBar::static_meta();
}

void i3UITemplate_ProgressBar::SpreadLayout(REAL32 * pCX, REAL32 * pCY, i3::pack::RECT * pRects, INT32 shapeCount)
{
