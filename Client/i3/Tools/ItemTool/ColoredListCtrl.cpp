...
// BOOL CColoredListCtrl::SetColumnWidth(int nCol, int nWidth)
// {	
// 	CRect r;
...
// 
// 		int nElpase = 17 / nColumnCnt;
// 		//if (nColumnCnt > 1)
// 		{
// 			//return CListCtrl::SetColumnWidth(nCol, nWidth-nElpase);
// 		}
// 	}
// 
// 	return CListCtrl::SetColumnWidth(nCol, nWidth);
// }

void CColoredListCtrl::ReCalColumnSize()
{
	CHeaderCtrl* pHeader = GetHeaderCtrl();
	int nColumnCnt = pHeader->GetItemCount();
	...
	{
		int nColW = GetColumnWidth(i);

		int nElapse = 17 / nColumnCnt;

		CListCtrl::SetColumnWidth(i, nColW - nElapse);
	}
}