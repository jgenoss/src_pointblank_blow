================================================================================
              MFC 라이브러리 : i3PackFileEditor 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 i3PackFileEditor 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 i3PackFileEditor 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.

i3PackFileEditor.vcproj
...
i3PackFileEditor.h
    ...
    특정 헤더가 포함되며 Ci3PackFileEditorApp 응용 프로그램 클래스가 선언됩니다.

i3PackFileEditor.cpp
    Ci3PackFileEditorApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
LeftView.h, LeftView.cpp
    CTreeView에서 파생된 CLeftView 왼쪽 프레임 클래스를 포함하는
    파일입니다.
res\Toolbar.bmp
    도구 모음에 바둑판식 이미지를 만들 때 사용되는 비트맵 파일입니다.
    초기 도구 모음 및 상태 표시줄은 CMainFrame 클래스에 구성됩니다.
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 i3PackFileEditor.rc의
    IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추에 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 단일 문서 종류 및 단일 뷰를 만듭니다.

i3PackFileEditorDoc.h, i3PackFileEditorDoc.cpp - 문서
    Ci3PackFileEditorDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (Ci3PackFileEditorDoc::Serialize 사용).
    이 문서에는 다음 문자열이 포함됩니다.
        파일 확장명:         i3PackProject
        파일 형식 ID:        i3PackFileEditor.Document
        주 프레임 캡션:      i3PackFileEditor
        문서 종류 이름:      i3PackProject
        필터 이름:           i3PackFileEditor Files (*.i3PackProject)
        파일 새 약식 이름:   i3PackProject
        파일 형식 정식 이름: i3PackFileEditor.Document
i3PackFileEditorView.h, i3PackFileEditorView.cpp - 문서 뷰
    Ci3PackFileEditorView 클래스를 포함하는 파일입니다.
    Ci3PackFileEditorView 개체를 사용하여 Ci3PackFileEditorDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) i3PackFileEditor.pch 및 미리 컴파일된
