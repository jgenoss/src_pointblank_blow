// i3EffectEditor.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(Ci3EffectEditorApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// Ci3EffectEditorApp 생성

Ci3EffectEditorApp::Ci3EffectEditorApp()
{
...
// 유일한 Ci3EffectEditorApp 개체입니다.

Ci3EffectEditorApp theApp;


// Ci3EffectEditorApp 초기화

BOOL Ci3EffectEditorApp::InitInstance()
{
...
//	}
...

	{
		...
		I3ASSERT( g_pOption != NULL);
	}

	Ci3EffectEditorDlg dlg;
	m_pMainWnd = &dlg;
...
int Ci3EffectEditorApp::ExitInstance()
{
	if( g_pOption != NULL)
	{
		g_pOption->Save();
