// i3Graph.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(Ci3GraphApp, CWinApp)
...
// 유일한 Ci3GraphApp 개체입니다.

Ci3GraphApp theApp;

Ci3GraphDlg *g_pMainWnd = NULL;

// Ci3GraphApp 초기화

BOOL Ci3GraphApp::InitInstance()
{
	...
	{	
		...
		i3Error::SetChannelName( I3LOG_FATAL, "i3Graph.log");
		i3Error::SetChannelName( I3LOG_WARN, "i3Graph.log");
