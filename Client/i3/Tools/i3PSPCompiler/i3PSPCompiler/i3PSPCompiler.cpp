// i3PSPCompiler.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(Ci3PSPCompilerApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// Ci3PSPCompilerApp 생성

Ci3PSPCompilerApp::Ci3PSPCompilerApp()
{
...
// 유일한 Ci3PSPCompilerApp 개체입니다.

Ci3PSPCompilerApp theApp;


// Ci3PSPCompilerApp 초기화

BOOL Ci3PSPCompilerApp::InitInstance()
{
	...
	// 적절한 내용으로 수정해야 합니다.
	SetRegistryKey(_T("i3PSPCompiler"));

	Ci3PSPCompilerDlg dlg;
	m_pMainWnd = &dlg;
