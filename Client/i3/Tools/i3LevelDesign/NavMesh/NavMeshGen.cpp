...
{
	/*m_GenType = GENERATE_BY_GEOMETRY;
...
//bool	CNavMeshGen::DoGenerate( i3World* world, const navMeshConfig& cfg )
//{
//	if( m_world == world )
//	{
//		return false;
...
//	switch( m_GenType )
//	{
//	case	GENERATE_BY_GEOMETRY:
//			bGen = _CalculateVertexList_byGeometry();
//			break;
//
//	case	GENERATE_BY_TRANSFORM2:
//			bGen = _CalculateVertexList_byTransform2();
//			break;
//	}
//
//	if( bGen )
//		return _DoGenerate( cfg );
//
//	return false;
//}
//
//bool	CNavMeshGen::_CalculateVertexList_byGeometry()
//{
//	i3::vector< i3Node* > nodeList;
//	i3Scene::FindNodeByExactType( m_world->getWorldRoot(), i3Geometry::GetClassMeta(), nodeList );
//
...
//	}
//
//	std::vector< std::pair< i3GeometryAttr*, RT_MATRIX > >	geomList;
//
//	// get geometry list
//	{
//		RT_MATRIX wmat;	
...
//		m_ntri = 0;
//
//		for each( std::pair< i3GeometryAttr*, RT_MATRIX > p in geomList )
//		{
...
//
//
//bool	CNavMeshGen::_CalculateVertexList_byTransform2()
//{
//	i3::vector< i3Node* > nodeList;
//	i3Scene::FindNodeByExactType( m_world->getWorldCollision()->getInstanceSg(), i3Transform2::GetClassMeta(), nodeList );
//	i3Scene::FindNodeByExactType( m_world->getHitCollision()->getInstanceSg(), i3Transform2::GetClassMeta(), nodeList );
//
//	if( true == nodeList.empty() )
//	{
//		return false;
//	}
//
//	std::vector< std::pair< i3Transform2*, RT_MATRIX > > tfm2List;
//
//	// calculate wtm
//	{
//		RT_MATRIX wmat;
...
//		m_ntri = 0;
//
//		for each( std::pair< i3Transform2*, RT_MATRIX > p in tfm2List )
//		{
...
//
//
//void	CNavMeshGen::_CalculateWTM( i3Node* node, RT_MATRIX& wmat )
//{
...
//	while( NULL != node )
//	{
//		if( node->IsTypeOf( i3Transform::GetClassMeta() ) )
//		{
...
//}
//
//bool	CNavMeshGen::_DoGenerate( const navMeshConfig& cfg )
//{
//	if( NULL == m_verts || NULL == m_tris )
//	{
//		return false;
//	}
//
