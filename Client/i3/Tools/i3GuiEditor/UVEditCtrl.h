...
protected:
	...
	void		_SetValidRect(i3GuiImage * pImage);
	...
	char		_DrawText[MAX_PATH];

	void		SetDrawText( i3GuiImage * pImage);
public:
	afx_msg BOOL OnMouseWheel(UINT nFlags, short zDelta, CPoint pt);
	afx_msg void OnMouseMove(UINT nFlags, CPoint point);

	void		 SetImageForEditUV( i3GuiImage * pImage );
