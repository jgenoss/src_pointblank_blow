...
BOOL CEditDlgAction_PlaySound::OnInitDialog()
{
	...
	// TODO:  Add extra initialization here
	{
		...
		{
			i3::safe_string_copy( conv, pInfo->getSound()->GetName(), MAX_PATH );
		}
...
void CEditDlgAction_PlaySound::OnOK()
{
	...
	
	{
		...
		m_pNode->setStartTime( (REAL32)atof( conv));
...
void CEditDlgAction_PlaySound::OnBnClickedEdSoundFileselect()
{
	...
	{
		I3PRINTLOG(I3LOG_WARN, "File을 읽어들이지 못하였습니다");
		return ;
	}
	...
	i3::make_relative_path( g_pProfile->m_szWorkDir, szFullPath, szFilePath  );
