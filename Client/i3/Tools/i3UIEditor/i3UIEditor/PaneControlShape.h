...
public:
	...
	i3List					m_listSelected;

	i3UIControl	*		m_pParentCtrl;
	BOOL					m_bFromControl;
...
protected:
	void	InitTemplate(i3UITemplate* pElement);			//템플릿 초기화
	bool	InitShapeRect(i3UITemplate* pElement);			//Shape 리스트를 초기화
	void	_SetShapeRect(i3UIImage * pImage, INT32	nIndex);	//초기화 된 리스트중 변경사항만 다시 셋
	...
	void	_InitUV(INT32	nShapeIndex, i3UIImage * pImage);
