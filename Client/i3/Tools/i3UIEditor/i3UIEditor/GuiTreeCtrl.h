...
protected:
	...
	void			_Rec_CreateClone( i3GameObjBase * pSrcNode, i3GameObjBase * pDstNode, I3_COPY_METHOD method);
	i3GameObjBase *	_CreateClone( i3GameObjBase * pSrcNode, I3_COPY_METHOD method);
