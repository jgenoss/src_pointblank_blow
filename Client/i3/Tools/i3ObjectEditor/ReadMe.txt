================================================================================
              MFC 라이브러리 : i3ObjectEditor 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 i3ObjectEditor 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 i3ObjectEditor 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.

i3ObjectEditor.vcproj
...
i3ObjectEditor.h
    ...
    특정 헤더가 포함되며 Ci3ObjectEditorApp 응용 프로그램 클래스가 선언됩니다.

i3ObjectEditor.cpp
    Ci3ObjectEditorApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\i3ObjectEditor.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.
    이 아이콘은 주 리소스 파일인 i3ObjectEditor.rc에 포함됩니다.

res\i3ObjectEditor.rc2
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) i3ObjectEditor.pch 및 미리 컴파일된
