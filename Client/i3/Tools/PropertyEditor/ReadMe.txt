================================================================================
              MFC 라이브러리 : PropertyEditor 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 PropertyEditor 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 PropertyEditor 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.

PropertyEditor.vcproj
...
PropertyEditor.h
    ...
    특정 헤더가 포함되며 CPropertyEditorApp 응용 프로그램 클래스가 선언됩니다.

PropertyEditor.cpp
    CPropertyEditorApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\PropertyEditor.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.
    이 아이콘은 주 리소스 파일인 PropertyEditor.rc에 포함됩니다.

res\PropertyEditor.rc2
...
res\Toolbar.bmp
    ...
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 PropertyEditor.rc의
    IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추에 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 단일 문서 종류 및 단일 뷰를 만듭니다.

PropertyEditorDoc.h, PropertyEditorDoc.cpp - 문서
    CPropertyEditorDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (CPropertyEditorDoc::Serialize 사용).
    이 문서에는 다음 문자열이 포함됩니다.
        파일 확장명:         PEF
        파일 형식 ID:        PropertyEditor.Document
        주 프레임 캡션:      PropertyEditor
        문서 종류 이름:      PropertyEditor
        필터 이름:           PropertyEditor Files (*.PEF)
        파일 새 약식 이름:   PropertyEditor
        파일 형식 정식 이름: PropertyEditor.Document
PropertyEditorView.h, PropertyEditorView.cpp - 문서 뷰
    CPropertyEditorView 클래스를 포함하는 파일입니다.
    CPropertyEditorView 개체를 사용하여 CPropertyEditorDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) PropertyEditor.pch 및 미리 컴파일된
