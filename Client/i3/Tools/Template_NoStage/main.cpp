                     ...
                     int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_WINDOW_CLASS);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, (LPCTSTR)IDI_TEMPLATE_NOSTAGE);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= (LPCTSTR)IDC_WINDOW_CLASS;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
...

	{
		...
		g_pFramework = CFramework::NewObject();
