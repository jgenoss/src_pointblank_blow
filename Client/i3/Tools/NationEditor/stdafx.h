...
typedef std::vector< WString > TStringVector;
...
{
	String Name;	//파일 이름
	String Path;	//파일 경로(파일 이름 포함)
	i3RegistrySet_Impl * pRegistrySet = nullptr;
};

typedef std::vector< PefContext* > PefContextBank;
typedef std::vector< UINT > OrderList;
