================================================================================
              MFC 라이브러리 : i3RSCGen 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 i3RSCGen 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 i3RSCGen 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
i3RSCGen.h
    ...
    특정 헤더가 포함되며 Ci3RSCGenApp 응용 프로그램 클래스가 선언됩니다.

i3RSCGen.cpp
    Ci3RSCGenApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\i3RSCGen.ico
    ...
    이 아이콘은 주 리소스 파일인 i3RSCGen.rc에 포함됩니다.
...
i3RSCGenDoc.h, i3RSCGenDoc.cpp - 문서
    Ci3RSCGenDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (Ci3RSCGenDoc::Serialize 사용).
i3RSCGenView.h, i3RSCGenView.cpp - 문서 뷰
    Ci3RSCGenView 클래스를 포함하는 파일입니다.
    Ci3RSCGenView 개체를 사용하여 Ci3RSCGenDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) i3RSCGen.pch 및 미리 컴파일된
