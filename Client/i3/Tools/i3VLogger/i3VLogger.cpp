// i3VLogger.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(Ci3VLoggerApp, CWinApp)
...
// 유일한 Ci3VLoggerApp 개체입니다.

Ci3VLoggerApp theApp;


// Ci3VLoggerApp 초기화

BOOL Ci3VLoggerApp::InitInstance()
{
...
int Ci3VLoggerApp::ExitInstance()
{
