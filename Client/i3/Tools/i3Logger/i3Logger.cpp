// i3Logger.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(Ci3LoggerApp, CWinApp)
...
BOOL Ci3LoggerApp::InitInstance()
{
