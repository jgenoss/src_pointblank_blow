// i3ExternRef.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(Ci3ExternRefApp, CWinApp)
...
Ci3ExternRefApp::Ci3ExternRefApp()
{
...
// 유일한 Ci3ExternRefApp 개체입니다.

Ci3ExternRefApp theApp;
COptionInfo	*	g_pOption;

// Ci3ExternRefApp 초기화

BOOL Ci3ExternRefApp::InitInstance()
{
...
int Ci3ExternRefApp::ExitInstance()
{
	delete g_pOption;
