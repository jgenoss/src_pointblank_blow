================================================================================
    MFC 라이브러리 : i3GICShapeTool 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 i3GICShapeTool 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램
작성을 위한 기본 구조를 제공합니다.

이 파일에는 i3GICShapeTool 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

i3GICShapeTool.vcproj
...
i3GICShapeTool.h
    ...
    헤더(Resource.h 포함)가 들어 있고 Ci3GICShapeToolApp 응용 프로그램
    클래스를 선언합니다.

i3GICShapeTool.cpp
    응용 프로그램 클래스 Ci3GICShapeToolApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\i3GICShapeTool.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 i3GICShapeTool.rc에 의해 포함됩니다.

res\i3GICShapeTool.rc2
...
i3GICShapeToolDoc.h, i3GICShapeToolDoc.cpp - 문서
    이 파일에는 Ci3GICShapeToolDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 Ci3GICShapeToolDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

i3GICShapeToolView.h, i3GICShapeToolView.cpp - 문서 뷰
    이 파일에는 Ci3GICShapeToolView 클래스가 들어 있습니다.
    Ci3GICShapeToolView 개체는 Ci3GICShapeToolDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 i3GICShapeTool.pch와
