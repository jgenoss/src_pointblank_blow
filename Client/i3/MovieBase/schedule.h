...
private:
    ...
    {
    public:
		CAdvisePacket() : m_dwAdviseCookie(NULL), m_rtEventTime(0L), m_rtPeriod(0L), m_hNotify(NULL), m_next(NULL), m_bPeriodic( FALSE)
        {}
        ...
        CAdvisePacket( __inout_opt CAdvisePacket * next, LONGLONG time ) : m_next(next), m_rtEventTime(time), m_hNotify(NULL), m_bPeriodic( FALSE), m_dwAdviseCookie(NULL), m_rtPeriod(0L)
        {}
