...
// 
// 1. Base
// i3SoundProperty			: 재생시킬 소리정보( nullptr)
...
{
	I3_EXPORT_CLASS_DEFINE( i3SoundPlayArgument, i3NamedElement);

protected:
	//Volatile members
	i3SoundPlayState	*	m_pPlayState = nullptr;
	UINT32					m_nState = 0;
	

	//Persistant members
	i3SoundProperty		*	m_pProperty = nullptr;

	UINT32					m_n3DMode = I3SND_RT_3DMODE_DISABLE;
