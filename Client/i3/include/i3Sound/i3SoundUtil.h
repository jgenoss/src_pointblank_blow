...
UINT32	I3_EXPORT_SOUND I3SNDUtil_LoadFileInfo( i3Stream * pStream, i3::pack::SOUND_INFO_HEADER * pInfo);
UINT32	I3_EXPORT_SOUND I3SNDUtil_LoadWaveFileFormat(const char * szSndName, WAVEFORMATEX * waveFormatEx, HMMIO hMMIO = nullptr);
