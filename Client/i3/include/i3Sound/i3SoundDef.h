...
namespace i3
{
	namespace pack
	{
		...
		{
			UINT8				m_nID[4] = { 0 };			// wav, i3snd, 등 고유 ID를 저장합니다. 초기화값을 설정하지 않습니다.
			UINT32				m_nFormat = 0;
...
struct ALIGN1 I3SND_FMOD_POLYGON
{
	...
	REAL32			_rDirectOcclusion = 0.0f;		//Reverb가 적용되지 않은 Occlusion의 볼륨
	REAL32			_rReverbOcclusion = 0.0f;		//Reverb가 적용된 Occlusion의 볼륨
	UINT8			_bDoubleSided = 0;			//트라이앵글이 양방향 모두 적용되는지의 여부
	UINT8			_pad[3] = { 0 };
