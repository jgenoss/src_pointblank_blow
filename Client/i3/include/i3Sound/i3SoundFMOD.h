...
//	I3_CLASS_DEFINE( i3SoundFMOD );
	I3_EXPORT_CLASS_DEFINE_BY_TYPE(i3SoundFMOD, i3Sound, i3::cms_concrete_fmod::value);
protected:

	FMOD::Sound	 *		m_p3DSound = nullptr;
	FMOD::Sound *		m_p2DSound = nullptr;

	UINT32				m_nDataLength = 0;	//i3SoundFMOD에서는 m_nDataSize는 메모리버퍼크기이고 m_nDataLength가 실제 사운드데이터의 길이를 나타냄
...
public:
	...
	virtual REAL32		GetDuration() override;
	virtual bool		Create( char * pszPath) override;
