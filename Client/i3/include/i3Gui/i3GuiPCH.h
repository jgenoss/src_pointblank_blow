#ifndef __I3GUI_PCH_H__
#define __I3GUI_PCH_H__
	...
	#define WINVER 0x0501		// Windows 98과 Windows 2000 이후 버전에 맞도록 적합한 값으로 변경해 주십시오. ==> XP급으로 변경했다. (2015.0831.수빈)
	#endif
