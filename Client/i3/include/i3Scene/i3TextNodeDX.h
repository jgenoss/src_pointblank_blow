...
{
	I3_EXPORT_CLASS_DEFINE( i3TextNodeDX, i3AttrSet);

protected:
	i3TextAttrDX*			m_pTextAttrDX = nullptr;
...
public:
	...
	void		SetText( const char* pszText)							{ m_pTextAttrDX->SetText( pszText);					}
	const char*	getText(void)											{ return m_pTextAttrDX->getText();					}
	...
	INT32		getCharacterSizeX( const char *pszText)					{ return m_pTextAttrDX->GetCharacterSizeX(pszText);	}
