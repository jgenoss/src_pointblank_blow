...
{
	I3_EXPORT_CLASS_DEFINE( i3RenderTargetAttr, i3RenderAttr);
protected:
	i3Texture *				m_pRT = nullptr;
	i3Texture *				m_pDepthRT = nullptr;

	INT32					m_Width = 0;
	INT32					m_Height = 0;
	I3G_IMAGE_FORMAT		m_Format = I3G_IMAGE_FORMAT_DEFAULT_COLOR;
	I3G_IMAGE_FORMAT		m_DepthFormat = I3G_IMAGE_FORMAT_D24X8;
	I3SG_RENDERTARGET_MODE	m_Mode = I3SG_RENDERTARGET_MODE_SET;
