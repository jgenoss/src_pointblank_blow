...
{
	I3_EXPORT_CLASS_DEFINE( i3PhysixJointInfoD6, i3PhysixJointInfo);
public:
	/**
	...
	*/
	NxD6JointMotion			xMotion = NX_D6JOINT_MOTION_FREE, yMotion = NX_D6JOINT_MOTION_FREE, zMotion = NX_D6JOINT_MOTION_FREE;
	...
	<b>Default:</b> NX_D6JOINT_MOTION_FREE
	*/
	NxD6JointMotion			swing1Motion = NX_D6JOINT_MOTION_FREE, swing2Motion = NX_D6JOINT_MOTION_FREE, twistMotion = NX_D6JOINT_MOTION_FREE;
	...
	*/
	NxJointProjectionMode	projectionMode = NX_JPM_NONE;
	...
	<b>Default:</b> 0.1
	*/
	REAL32					projectionDistance = 0.1f;	
...
public:
	virtual void	SetFrom( NxJointDesc * pDesc) override;
	virtual void	SetTo( NxJointDesc * pDesc) override;

	virtual void	CopyTo( i3ElementBase * pDesc, I3_COPY_METHOD method) override;
