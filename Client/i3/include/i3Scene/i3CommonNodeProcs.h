...
//
BEGIN_INLINE
void _copyTop( MATRIX * pDest, i3MatrixStack * pStack)
{
	#if defined( I3_PSP)
		__asm__ (
			".set			push\n"					//
...
//
BEGIN_INLINE
void _copyTopWorld( i3SceneTracer * pTracer, MATRIX * pDest, i3MatrixStack * pStack)
{
...
//
BEGIN_INLINE
void _setInverseModelView3x3(  MATRIX * pDest, i3MatrixStack * pStack, i3SceneTracer * pTracer)
{
	if( pTracer->IsStyle( I3SG_TRACER_STYLE_NO_VIEWMATRIX))
	{
		#if defined( I3_PSP)
