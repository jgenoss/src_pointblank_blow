#if !defined( __I3_SPRITE_H)
#define __I3_SPRITE_H
...
class I3_EXPORT_SCENE i3Sprite : public i3AttrSet
{
	I3_EXPORT_CLASS_DEFINE( i3Sprite, i3AttrSet);
protected:
	...
	i3SpriteAttr*			m_pSprite;		// [initialize at constructor]
...
public:
	i3Sprite(void);
	virtual ~i3Sprite(void);

	void		Create( UINT32 Count, bool bUV, bool bColor, bool bAlwaysUpdate);
	...
	void		SetRotationX( UINT32 Index,REAL32 rotation)				{ m_pSprite->SetRotationX( Index,rotation);}
	void		SetRotationY( UINT32 Index,REAL32 rotation)				{ m_pSprite->SetRotationY( Index,rotation);}
