//*******************************************************************************************************
//	Nvidia 사이트에서 공개한 NvTriStip 소스 (최대한 원본 소스 그대로 사용함)
//	by KOMET 2006.02.06
//	참조 사이트 http://developer.nvidia.com/object/nvtristrip_library.html
//	note:	Microsoft의 STL 자료구조와 new, delete 함수를 사용한다.
//*******************************************************************************************************
...
{
	PrimType type = PrimType::PT_STRIP;
