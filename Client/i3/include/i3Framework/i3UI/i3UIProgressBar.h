#ifndef __I3UI_PROGRESSBAR_H__
#define __I3UI_PROGRESSBAR_H__

#include "i3UICaptionControl.h"

class I3_EXPORT_FRAMEWORK i3UIProgressBar : public i3UICaptionControl	
{
	I3_EXPORT_CLASS_DEFINE( i3UIProgressBar, i3UICaptionControl);

protected:
	REAL32			m_rProgress = 0.7f;	//min: 0.0f, max: 1.0f
