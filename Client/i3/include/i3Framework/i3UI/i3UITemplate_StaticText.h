#ifndef __I3UITEMPLATE_STATICTEXT_H__
#define __I3UITEMPLATE_STATICTEXT_H__

#include "i3UITemplate.h"

enum I3UI_STATICTEXT_SHAPE
{
	I3UI_STATICTEXT_SHAPE_IMAGE = 0,
	
	I3UI_STATICTEXT_SHAPE_COUNT,
};

class I3_EXPORT_FRAMEWORK i3UITemplate_StaticText : public i3UITemplate
{
	I3_EXPORT_CLASS_DEFINE( i3UITemplate_StaticText, i3UITemplate );

protected:
	i3UIShape	m_pShape[I3UI_STATICTEXT_SHAPE_COUNT];

public:	
	virtual INT32			getShapeCount()	const	{	return I3UI_STATICTEXT_SHAPE_COUNT;}
...
#endif // __I3UITEMPLATE_STATICTEXT_H__
