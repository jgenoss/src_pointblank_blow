...
namespace i3
{
	namespace detail
	{
		...
		struct has_new_operator_impl
		{
			...
			template<class U> static yes_type check_sig1(U*, test<void* (*)(std::size_t), &U::operator new >* = nullptr);
			template<class U> static no_type  check_sig1(...);
			
			template<class U> static yes_type check_sig2(U*, test<void* (*)(std::size_t, const std::nothrow_t&), &U::operator new>* = nullptr);
			template<class U> static no_type  check_sig2(...);
			
			template<class U> static yes_type check_sig3(U*, test<void* (*)(std::size_t, void*), &U::operator new>* = nullptr);
			template<class U> static no_type  check_sig3(...);
			
			template<class U> static yes_type check_sig4(U*, test<void* (*)(std::size_t), &U::operator new[]>* = nullptr);
			template<class U> static no_type  check_sig4(...);

			template<class U> static yes_type check_sig5(U*, test<void* (*)(std::size_t, const std::nothrow_t&), &U::operator new[]>* = nullptr);
			template<class U> static no_type  check_sig5(...);

			template<class U> static yes_type check_sig6(U*, test<void* (*)(std::size_t, void*), &U::operator new[]>* = nullptr);
