...
#ifndef   pp_ft_components_impl_function_h
#define  pp_ft_components_impl_function_h
...
namespace i3
{
	namespace ft
	{
		namespace detail
		{
			#define		pp_iteration_params_1	(3, (0, ft_arity_limit, "pp_ft_components_impl_function.h"))				// 1단계 파일반복..
			#include	pp_iterate()
		}
	}
}
