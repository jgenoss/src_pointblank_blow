...
namespace i3
{
	namespace detail
	{
		...
		FwdIt1>::type find_first_of_impl(FwdIt1 f1, FwdIt1 l1, FwdIt2 f2, FwdIt2 l2)
		{
			for (; f1 != l1; ++f1)
			{
				for (FwdIt2 mid2 = f2; mid2 != l2; ++mid2)
				{
					if (*f1 == *mid2) return f1;
				}
			}
			return f1;
		}
	...
	{
		return detail::find_first_of_impl(f1, l1, f2, l2);
	}
