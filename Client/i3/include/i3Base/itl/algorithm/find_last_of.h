...
// reverse_iterator + find_first_of 조합을 써도 되지만..직관적이지 않아서..
// 별도 구현해둔다..
...
namespace i3
{
	...
	BidIt1>::type find_last_of(BidIt1 f1, BidIt1 l1, FwdIt2 f2, FwdIt2 l2)
	{
		if ( f1 == l1 )
		...
		while ( --it  )
		{
			for (FwdIt2 mid2 = f2; mid2 != l2; ++mid2)
			{
				if (*it == *mid2) return it;
			}
	...
	BidIt1 find_last_of(BidIt1 f1, BidIt1 l1, FwdIt2 f2, FwdIt2 l2, Pred2 pr)
	{
		if ( f1 == l1 )
			return l1;				// 못찾으면 어쨋거나 l1으로 끝낸다..
