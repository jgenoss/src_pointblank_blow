...
namespace i3
{
	...
	public:
		...
		{
		#if defined( I3_DEBUG)
			NetworkDump_Free( _Ptr, __FILE__, __LINE__);
		#endif
		...
		{
		#if defined( I3_DEBUG)
			pointer p = (pointer) ::operator new( _Count * sizeof(T) );
			NetworkDump_Malloc( p, _Count * sizeof(T), __FILE__, __LINE__);
			return p;
		#else
			return (pointer) ::operator new( _Count * sizeof(T) );
		#endif
