...
public:
	...
	void		addAttr(const char * pszName, bool val) { SetAttribute(pszName, val ? 1 : 0); }
	...
	const char *	getAttr(const char * pszName, bool * pVal) { int val; const char *rv = Attribute(pszName, &val); *pVal = val != 0; return rv; }
