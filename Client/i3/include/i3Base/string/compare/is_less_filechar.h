...
namespace i3
{
	struct is_less_filechar
	{
		...
		bool operator()(const T1& lhs, const T2& rhs)
		{
			...
			unsigned_type1 lhs2 = (lhs == unsigned_type1('\\')) ? unsigned_type1('/') : to_lower_functor_fast<unsigned_type1>()(lhs);
			unsigned_type2 rhs2 = (rhs == unsigned_type2('\\')) ? unsigned_type2('/') : to_lower_functor_fast<unsigned_type2>()(rhs);
