...
#include "../../itl/range/algorithm/find_last_of.h"
...
namespace i3
{
	...
	{
		return range::find_last_of(i3::as_literal(input), i3::as_literal(delimit));	
	}
	...
	{
		return range::rfind(i3::as_literal(input), delimit_c);
	}
	...
	{
		return range::find_last_of(i3::iterator_range<InIt>(beg, end), i3::as_literal(delimit));
	}
	...
	{
		return i3::rfind(beg, end, delimit_c);
	}
