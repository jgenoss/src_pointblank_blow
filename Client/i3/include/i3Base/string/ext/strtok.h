...
namespace i3
{
	...
	{
		return i3::split(Result, i3::as_literal(Input), detail::make_strtok_delimit_functor(i3::as_literal(delimit) ), token_compress);
	}
	...
	{
		return i3::split(Result, i3::as_literal(Input), detail::make_strtok_delimit_c_functor(delimit_c), token_compress);
	}
