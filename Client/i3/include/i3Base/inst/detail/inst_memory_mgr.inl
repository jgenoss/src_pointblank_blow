...
namespace i3
{
	...
	namespace detail_inst
	{
		...
		{
			void * pData = i3::heap_aligned_malloc(i3::get_process_heap(), sizeof(T), __alignof(T));
			return shared_inst(new (pData) T );
		}
...
namespace i3
{
	...
	namespace detail_inst 
	{
		...
		{
#if defined( I3_DEBUG)
			void * pData = i3::heap_aligned_malloc(i3::get_process_heap(), sizeof(T), __alignof(T), __FILE__, __LINE__);
#else
			void * pData = i3::heap_aligned_malloc(i3::get_process_heap(), sizeof(T), __alignof(T));
#endif
			return shared_inst(new (pData) T( pp_enum_params_1(i_, p) ) );
		}
