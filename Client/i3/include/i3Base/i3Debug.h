...
//	I3_EXPORT_BASE void i3Log( const char * pszModule, const char *pszFormat, ...);
	I3_EXPORT_BASE void i3Log( const i3::literal_range& strModule, const i3::literal_range& strFormat);
	I3_EXPORT_BASE void i3Log( const i3::wliteral_range& wstrModule, const i3::wliteral_range& wstrFormat);
