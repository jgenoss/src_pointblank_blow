...
I3_EXPORT_BASE void REPORT_PROFILE( char * pszDest = nullptr);
I3_EXPORT_BASE void REPORT_PROFILE( i3::string& inout);
I3_EXPORT_BASE void REPORT_PROFILE_CALLBACK( PF_CALLBACK pUserProc, void * pData);
