...
// and Release. All ref-counting should be done by the ISmartPtrCOM 
...
public:
    ...
    // Copy ctor
    ISmartPtrCOM(const ISmartPtrCOM& sptr)
    {
        m_ptr = sptr.m_ptr;
        if (m_ptr)
        {
    ...
    // Assignment
    ISmartPtrCOM& operator=(const ISmartPtrCOM& sptr)
    {
