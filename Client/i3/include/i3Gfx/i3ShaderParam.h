...
#define I3G_SHADER_PMASK_MATRIX_TEX			0x08000000
#define I3G_SHADER_PMASK_LIGHT0				0x04000000
#define I3G_SHADER_PMASK_LIGHT1				0x02000000
#define I3G_SHADER_PMASK_MATERIAL			0x01000000
#define I3G_SHADER_PMASK_AMBIENT			0x00800000
#define I3G_SHADER_PMASK_COLOR				0x00400000
#define	I3G_SHADER_PMASK_TEX_DIFFUSE		0x00200000
#define I3G_SHADER_PMASK_TEX_LUX			0x00100000
#define I3G_SHADER_PMASK_TEX_SPECULAR		0x00080000
#define I3G_SHADER_PMASK_TEX_NORMAL			0x00040000
#define I3G_SHADER_PMASK_TEX_REFLECT		0x00020000
#define I3G_SHADER_PMASK_TEX_REFLECT_MASK	0x00010000
#define I3G_SHADER_PMASK_TEX_EMISSIVE		0x00008000
#define I3G_SHADER_PMASK_FRESNEL			0x00004000
#define I3G_SHADER_PMASK_SECONDARY_COLOR	0x00002000
#define I3G_SHADER_PMASK_TETRA_COLOR		0x00001000
#define I3G_SHADER_PMASK_XRAYCOLOR			0x00000800
#define I3G_SHADER_PMASK_ALL				0xFFFFF800
...
{
	I3_EXPORT_CLASS_DEFINE( i3ShaderParam, i3NamedElement);
...
public:
	enum SEMANTIC
	{
		...
		SEMANTIC_LIGHT_PROBE,

		SEMANTIC_SECONDARY_COLOR,
		SEMANTIC_TETRA_COLOR,

		SEMANTIC_TIME,
		SEMANTIC_MATRIX_INV_WORLD,
...
protected:
	// Persistent Members
	SEMANTIC	m_Semantic = SEMANTIC_CONSTANT;
	UINT32		m_UpdateMask = 0;
	TARGET		m_Target = TARGET_VERTEXSHADER;
	INT32		m_Index = 0;
...
public:
	...
	void		Update( MATRIX * pMatrix, INT32 count);
