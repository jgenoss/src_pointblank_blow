...
/////////////////////////////////////////////////////////////////////////////
// Raster Format
I3_EXPORT_GFX D3DFORMAT			i3DXUT_GetNativeImageFormat( I3G_IMAGE_FORMAT format, bool * bExact = nullptr);
I3_EXPORT_GFX I3G_IMAGE_FORMAT	i3DXUT_GetI3ImageFormat( D3DFORMAT format, bool * bExact = nullptr);
