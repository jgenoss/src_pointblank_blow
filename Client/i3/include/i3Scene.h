...
#include "i3Scene/i3GeometryResolver.h"
...
#include "i3Scene/i3MeshParticle.h"
#include "i3Scene/i3ParticleInfo.h"
...
#include "i3Scene/i3SceneIOQueue.h"
#include "i3Scene/i3SceneIOManager.h"

#include "i3Scene/i3DecalDef.h"
