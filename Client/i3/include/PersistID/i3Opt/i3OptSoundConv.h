...
typedef struct tag_ADPCMheader
{
...
{
	I3_CLASS_DEFINE( i3OptSoundConv );
protected:

public:
	i3OptSoundConv(void);
	virtual ~i3OptSoundConv(void);

protected:
	INT32	m_nDecodeFactor;
	INT32	m_nShiftFactor;
