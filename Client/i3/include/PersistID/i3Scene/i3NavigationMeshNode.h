...
{
	I3_CLASS_DEFINE( i3NavigationMeshNode );
protected:
	I3NM_INDEX				m_TriIndex;

	i3NavigationMeshNode	*m_pNvMeshNodeChild[4];
	i3List					*m_pNvMeshLeafList;

public:
	i3NavigationMeshNode();
	virtual ~i3NavigationMeshNode();
