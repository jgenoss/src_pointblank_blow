...
#if defined( I3_MEMREPORT ) && (defined( I3_WINDOWS ) || defined( I3_WINCE ))
...
#define	i3MemFree( p )					i3mem::Free(p, __FILE__, __LINE__)
...
#define	I3MEMORY_DEBUG_FILENAME_LEN		256

typedef struct I3MemBlock
{
	LPI3MEM			m_pPointer;
	I3MemBlock	*	m_Prev;
	I3MemBlock	*	m_Next;
...
#if defined( I3_MEMREPORT)
	char		m_Name[I3MEMORY_DEBUG_FILENAME_LEN]; 
	INT32		m_Line;
	UINT32		m_CRC;
#endif
...
typedef struct I3MemFileHeader
{
	char		m_FILE[4]; 
	UINT32		m_Ver; 
...
typedef struct I3MemFileBlockInfo
{
	LPI3MEM			m_MyPointer;
...
typedef struct _tagFileMappingHeader
{
	UINT32 _size;
	UINT32 _idxWrite;
	UINT32 _idxRead;	
...
namespace i3mem
{
	...
	//디버깅 용으로 사용합니다.
	I3_EXPORT_BASE INT32	GetAllocSize(INT32 BeforeSize = 0);
	...
	inline
	void	Copy( void * pDest, void * pSrc, UINT32 sz)
	{
