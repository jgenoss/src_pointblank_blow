...
namespace i3ZLib
{
	...
	// PackedZipFile Open
	I3_EXPORT_ZLIB bool	ZipFileOpen( i3FileStream * pOutStream, i3::vector<I3ZIP_FILEINFO*>* pOutFileList, const char * pszFileName );
	// 클로즈
	I3_EXPORT_ZLIB bool ZipFileClose( i3FileStream * pStream, i3::vector<I3ZIP_FILEINFO*>* pFileList );
	
	// AddFiletoZip
	I3_EXPORT_ZLIB UINT32 FileAddToZip( i3FileStream * pOutStream, i3::vector<I3ZIP_FILEINFO*>* pFileList, const char * pszAddFileName );

	// 파일 리스트 작성
	// return			: HeaderSize;
	// pZStream			: Opened ZipFile
	// pOutFileList		: I3ZIP_FILEINFO's List
	I3_EXPORT_ZLIB INT32 CreateZipFileList( i3FileStream * pZStream, i3::vector<I3ZIP_FILEINFO*>* pOutFileList );
	...
	I3_EXPORT_ZLIB UINT32 FileOpenFromZip( i3FileStream * pOutStream, i3FileStream * pZStream, i3::vector<I3ZIP_FILEINFO*>* pZFileList, const char * pszFileName );
