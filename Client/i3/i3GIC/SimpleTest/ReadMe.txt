================================================================================
              MFC 라이브러리 : SimpleTest 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 SimpleTest 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 SimpleTest 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
SimpleTest.h
    ...
    특정 헤더가 포함되며 CSimpleTestApp 응용 프로그램 클래스가 선언됩니다.

SimpleTest.cpp
    CSimpleTestApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\SimpleTest.ico
    ...
    이 아이콘은 주 리소스 파일인 SimpleTest.rc에 포함됩니다.
...
res\Toolbar.bmp
    ...
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 SimpleTest.rc의
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) SimpleTest.pch 및 미리 컴파일된
