...
I3_CLASS_INSTANCE( CRoomInTraining, CRoomBase );

CRoomInTraining::CRoomInTraining()
{
}
...
BOOL CRoomInTraining::OnCreate( TYPE_ROOM_INFO* pRoomInfo )
{
#ifndef NEW_EXPPOINT
...
void CRoomInTraining::OnDestroy()
{
}

BOOL CRoomInTraining::SetRoomOption( UINT32 ui32StageID )
{
...
BOOL CRoomInTraining::CheckRoundEnd( UINT32 ui32ServerTime )
{
...
BOOL CRoomInTraining::CheckMatchEnd()
{
...
INT32 CRoomInTraining::GetWinTeam()
{
...
#ifndef NEW_EXPPOINT
void CRoomInTraining::GetBasicExpPoint( INT32 i32Win, TYPE_ROOM_GET_EXPPOINT* pstGetExpPoint )
{
...
REAL32 CRoomInTraining::GetSubPercentOfUnusualEnd( INT32 i32Win )
{
...
UINT16 CRoomInTraining::GetMatchEndExp( INT32 i32Win, INT32 i32SlotIdx, UINT16 ui16AccExp, REAL32 rAdjustPercent, BOOL bNormalEnd, UINT32 ui32RTBattle )
{
	return (UINT16)(ui16AccExp * rAdjustPercent);
}

BOOL CRoomInTraining::CheckVoteTime( UINT32 ui32ServerTime )
{
