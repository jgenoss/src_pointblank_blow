...
public:
	...
	virtual bool			CheckLoadingStart()															{	return true;	}
	...
	virtual	UINT16			GetMatchEndExp( INT32 i32Win, INT32 i32SlotIdx, UINT16 ui16AccExp, REAL32 rAdjustPercent, BOOL bNormalEnd, UINT32 ui32RTBattle );
	virtual	UINT16			GetMatchEndPoint( INT32 i32Win, INT32 i32SlotIdx, UINT16 ui16AccPoint, REAL32 rAdjustPercent, BOOL bNormalEnd, UINT32 ui32RTBattle );
