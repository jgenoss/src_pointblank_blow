...
I3_CLASS_INSTANCE( CRoomInHeadKiller, CRoomBase );

CRoomInHeadKiller::CRoomInHeadKiller()
{
}
...
BOOL CRoomInHeadKiller::OnCreate( TYPE_ROOM_INFO* pRoomInfo )
{
#ifndef NEW_EXPPOINT
	// 보너스 경험치/포인트 (공통 설정사항)
...
void CRoomInHeadKiller::OnDestroy()
{
}

BOOL CRoomInHeadKiller::SetRoomOption( UINT32 ui32StageID )
{
...
void CRoomInHeadKiller::SetMatchStart()
{
	i3mem::FillZero( m_ui8MissionKill, sizeof(m_ui8MissionKill) );
}

#ifndef NEW_EXPPOINT
void CRoomInHeadKiller::UserKillBouns( INT32 i32SlotIdx, UINT32 ui32DeathType, UINT32 ui32DeathMyState, UINT32 ui32DeathEnemyState, UINT32 ui32RTBattle )
{
	...
	{
		m_ui8MissionKill[i32SlotIdx]++;
		m_pInfo->_aui8AccMissionCount[i32SlotIdx]++;
	}
}
#endif

BOOL CRoomInHeadKiller::CheckReady()
{
	//if( g_pContextMain->m_ui8MR_HeadKiller > m_pInfo->_SlotInfo[m_pInfo->_i32MainSlotIdx]._Rank )	return FALSE;

	return TRUE;
}

BOOL CRoomInHeadKiller::CheckRoundEnd( UINT32 ui32ServerTime )
{
...
BOOL CRoomInHeadKiller::CheckMatchEnd()
{
...
INT32 CRoomInHeadKiller::GetWinTeam()
{
...
#ifndef NEW_EXPPOINT
REAL32 CRoomInHeadKiller::GetSubPercentOfUnusualEnd( INT32 i32Win )
{
...
UINT16 CRoomInHeadKiller::GetMatchAccExp( INT32 i32SlotIdx, UINT16 ui16AccExp )
{
	...
	if (STAGE_SLOT_MODE_4VS4 == GET_STAGESLOT(m_pInfo->_InfoBasic._StageID))
		ui16Exp = ui16Exp + (m_ui8MissionKill[i32SlotIdx]*m_ui8BonusKillExp4VS4);
	else
		ui16Exp = ui16Exp + (m_ui8MissionKill[i32SlotIdx]*m_ui8BonusKillExp);

	return ui16Exp;
}
#endif

void CRoomInHeadKiller::AddStartBattlePacket( i3NetworkPacket* pPacket, CUserSession * pSession, UINT32 ui32RTBattle )
{
