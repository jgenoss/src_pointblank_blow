...
set LOCALE=Philippines
set EXE_NAME=PointBlank
set EXEC_NAME=PointBlank
set LOG_PATH=.
set EXE_ROOT=%CLIENT_EXES%\PhilippinesLive
...
set HSB_OUTPUT_PATH=%PB_SRC_ROOT%\HackShield\Server\HackShield_Philippines
set BUILD_CONFIG_QA=%CONFIG_QA%_Philippines
set BUILD_CONFIG_LIVE=%CONFIG_Live%_Philippines
