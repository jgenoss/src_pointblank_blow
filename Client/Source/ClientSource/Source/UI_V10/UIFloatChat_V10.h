...
#if !defined( __UI_FLOAT_CHAT_V10_H__)
#define __UI_FLOAT_CHAT_V10_H__
...
class UIFloatChat_V10 : public UIFloatingBase
{
	I3_CLASS_DEFINE( UIFloatChat_V10, UIFloatingBase);
...
protected:
	...
	/** \brief 모든 스프라이트의 앞으로 나오도록 한다.*/
	void			_FowardToTopMenuScreen( void);

public:
	UIFloatChat_V10();
	virtual ~UIFloatChat_V10();
...
public:
	...
	virtual void	InitChat( CHAT_AREA area, INT32 maxLineCount);
