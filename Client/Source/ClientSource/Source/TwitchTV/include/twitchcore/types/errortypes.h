...
#define TTV_ERROR_CODES\
	...
	DEFINE_TTV_ERROR_CODE(TTV_EC_SHUT_DOWN)\
	DEFINE_TTV_ERROR_CODE(TTV_EC_UNIMPLEMENTED)\
	DEFINE_TTV_ERROR_CODE(TTV_EC_ALREADY_LOGGED_IN)\
	DEFINE_TTV_ERROR_CODE(TTV_EC_INVALID_SUBMISSION_METHOD)\
	/* Socket errors */\
