#include "pch.h"
#include "UIPhaseLogin_V11.h"

I3_CLASS_INSTANCE(UIPhaseLogin_V11);//, UIPhaseBase);

UIPhaseLogin_V11::UIPhaseLogin_V11()
{
...
/*virtual*/ void UIPhaseLogin_V11::_InitializeAtLoad(i3UIScene * pScene)
{
	...
	i3Texture * pTexture = g_pFramework->GetResourceManager()->LoadTexture("Gui/Loading/Login_V1.i3i");
	I3ASSERT(pTexture);
	...
	m_pBG->AddTexture(pTexture, (REAL32)size.x, (REAL32)size.y);
