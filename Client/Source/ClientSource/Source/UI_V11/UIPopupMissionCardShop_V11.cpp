#include "pch.h"
#include "UIPopupMissionCardShop_V11.h"
...
I3_CLASS_INSTANCE( UIPopupMissionCardShop_V11);

static UIPopupMissionCardShop_V11 * GetThis( void)
{
	UIMainFrame * pFrame = g_pFramework->GetUIMainframe();
	I3ASSERT( pFrame);

	return (UIPopupMissionCardShop_V11*) pFrame->GetPopup( UPW_MISSIONSHOP );
}
...
//------------------------------------------------------------------------------//
extern "C" {
	int UIPopupMissionCardShop_V11_BuyOK(LuaState * L)
	{
		GetThis()->BuyCardOK();
		return 0;
	}

	int UIPopupMissionCardShop_V11_BuyCancel(LuaState * L)
	{
...
LuaFuncReg UIPopupMissionCardShop_Glue[] = {
	{"BuyCardOK",		UIPopupMissionCardShop_V11_BuyOK		},
	{"BuyCardCancel",	UIPopupMissionCardShop_V11_BuyCancel	},
	{nullptr,						nullptr}
};
...
UIPopupMissionCardShop_V11::UIPopupMissionCardShop_V11()
{
	m_CardSetType = 0;
}
...
void UIPopupMissionCardShop_V11::BuyCardOK()
{
...
void UIPopupMissionCardShop_V11::BuyCardCancel()
{
	GetMainFrame()->TogglePopup( UPW_MISSIONSHOP);
}

void UIPopupMissionCardShop_V11::OnCardBuyAll( INT32 cardSetType)
{
	// 선택카드 출력
...
/*virtual*/ void UIPopupMissionCardShop_V11::OnCreate( i3GameNode * pParent)
{
	UIPopupBase::OnCreate( pParent);

	AddScene("Scene/Popup/PointBlankRe_MyInfo_MissionCard_BuyNow.i3UIs",UIPopupMissionCardShop_Glue);
	// Load Scene
}

/*virtual*/ bool UIPopupMissionCardShop_V11::OnEntranceStart( void * pArg1, void * pArg2)
{
...
void UIPopupMissionCardShop_V11::_SetCardImage(ENUM_QUEST_CARDSET_TYPE Idx)
{
...
void UIPopupMissionCardShop_V11::_SetCardTitle(const i3::wliteral_range& wstrText)
{
...
void UIPopupMissionCardShop_V11::_SetCardPrice(const i3::wliteral_range& wstrText)
{
	LuaState* L = _CallLuaFunction("SetCardPrice");
	i3Lua::PushStringUTF16To8(L, wstrText);
	_EndLuaFunction(L, 1);
}
void UIPopupMissionCardShop_V11::_SetCardMymoney(const i3::wliteral_range& wstrText)
{
	LuaState* L = _CallLuaFunction("SetCardMymoney");
	i3Lua::PushStringUTF16To8(L, wstrText);
	_EndLuaFunction(L, 1);
}
void UIPopupMissionCardShop_V11::_SetCardMybalance(const i3::wliteral_range& wstrText)
{
...
void UIPopupMissionCardShop_V11::_SetCardConfirm(bool Sig)
{
