...
class UIPopupMissionCardShop_V11 : public UIPopupBase
{
	I3_CLASS_DEFINE( UIPopupMissionCardShop_V11, UIPopupBase);

	UIPopupMissionCardShop_V11();
	virtual ~UIPopupMissionCardShop_V11();
