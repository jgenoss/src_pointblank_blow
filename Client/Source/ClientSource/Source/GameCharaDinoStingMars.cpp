#include "pch.h"
#include "GameCharaDinoStingMars.h"
...
I3_CLASS_INSTANCE( CGameCharaDinoStingMars);

void CGameCharaDinoStingMars::_CreateDino( void)
{
...
/*virtual*/ void CGameCharaDinoStingMars::_PlayDinoSound_Fire(WEAPON::FIRE_ORDER fireOrder)
{
	switch(fireOrder)
	{
...
ID_UPPER_DINO_AI CGameCharaDinoStingMars::DinoAttack(WEAPON::FIRE_ORDER fireOrder)
{
...
void CGameCharaDinoStingMars::OnUpdate( REAL32 rDeltaSeconds)
{
...
void CGameCharaDinoStingMars::OnDinoAttackRun(i3AIContext * pCtx, REAL32 tm)
{
...
void CGameCharaDinoStingMars::ResetChara()
{
