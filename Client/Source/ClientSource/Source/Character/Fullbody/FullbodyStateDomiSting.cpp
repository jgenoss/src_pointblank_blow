...
namespace
{
	#define STING_WALK_LEFT_STEP_TIME		0.933f
	#define STING_WALK_RIGHT_STEP_TIME		0.333f 
	#define STING_RUN_LEFT_STEP_TIME		0.666f
	#define STING_RUN_RIGHT_STEP_TIME		0.266f
}
...
{
	m_breath = fb_misc::BreathFactory::CreateDomiSting(chara);
}
...
Walk::Walk(CGameCharaFullbody* chara, INT32 id, INT32 startAnimID, INT32 nextAnimID) 
	: AnimationBase(chara, id, startAnimID, nextAnimID)
{
	fb_misc::OneFootStepSound * pFootStepLeft = new fb_misc::OneFootStepSound(STING_WALK_LEFT_STEP_TIME, chara, DOMI_RAPTOR_BONE_FOOT_LEFT, true);
	fb_misc::OneFootStepSound * pFootStepRight = new fb_misc::OneFootStepSound(STING_WALK_RIGHT_STEP_TIME, chara, DOMI_RAPTOR_BONE_FOOT_RIGHT, false);
...
Run::Run(CGameCharaFullbody* chara, INT32 id, INT32 startAnimID, INT32 nextAnimID) 
	: AnimationBase(chara, id, startAnimID, nextAnimID)
{
	fb_misc::OneFootStepSound * pFootStepLeft = new fb_misc::OneFootStepSound(STING_RUN_LEFT_STEP_TIME, chara, DOMI_RAPTOR_BONE_FOOT_LEFT, true);
	fb_misc::OneFootStepSound * pFootStepRight = new fb_misc::OneFootStepSound(STING_RUN_RIGHT_STEP_TIME, chara, DOMI_RAPTOR_BONE_FOOT_RIGHT, false);
...
void DeathByGrenade::OnAnimStart() { fb_misc::Death(m_chara, GTBD_ON_STING); }
...
void DeathByHeadShot::OnAnimStart() { fb_misc::Death(m_chara, GTBD_ON_STING); }
...
void DeathMid1::OnAnimStart() { fb_misc::Death(m_chara, GTBD_ON_STING); }
...
void DeathMid2::OnAnimStart() { fb_misc::Death(m_chara, GTBD_ON_STING); }
...
void DeathMid3::OnAnimStart() { fb_misc::Death(m_chara, GTBD_ON_STING); }
