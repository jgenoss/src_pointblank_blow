#if !defined( __CROSSHAIR_SCOPE2_H)
#define __CROSSHAIR_SCOPE2_H

#include "Crosshair.h"

class Crosshair_Scope2 : public Crosshair
{
	I3_CLASS_DEFINE( Crosshair_Scope2, Crosshair);
...
public:
	Crosshair_Scope2(void);
	virtual ~Crosshair_Scope2(void);
