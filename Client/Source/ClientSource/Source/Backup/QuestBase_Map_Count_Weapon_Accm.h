#if !defined( __QUEST_BASE_MAP_COUNT_WEAPON_ACCM_H)
#define __QUEST_BASE_MAP_COUNT_WEAPON_ACCM_H

#include "QuestBase.h"

class CQuestBase_Map_Count_Weapon_Accm : public CQuestBase
{
	I3_CLASS_DEFINE( CQuestBase_Map_Count_Weapon_Accm, CQuestBase);
protected:
	UINT8				m_nValidKillCount;							//특정무기로 double/triple kill임무시 내부적으로 kill을 카운트한다.
...
public:
	CQuestBase_Map_Count_Weapon_Accm(void);
	virtual ~CQuestBase_Map_Count_Weapon_Accm(void);
