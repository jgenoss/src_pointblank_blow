...
/* read                                                                      */ 
/*---------------------------------------------------------------------------*/
//	template<>	char*				read(lua_State *L, int index, char c1 = 0);
//	template<>	const char*			read(lua_State *L, int index, short s1 = 0);
//	template<>	char				read(lua_State *L, int index, long l1 = 0);
//	template<>	unsigned char		read(lua_State *L, int index, int i1 = 0);
//	template<>	short				read(lua_State *L, int index, float f1 = 0.f);
//	template<>	unsigned short		read(lua_State *L, int index, double d1 = 0.0);
//	template<>	long				read(lua_State *L, int index, char c1 = 0, char c2 = 0);
//	template<>	unsigned long		read(lua_State *L, int index, short s1 = 0, short s2 = 0);
//	template<>	int					read(lua_State *L, int index, long l1 = 0, long l2 = 0);
//	template<>	unsigned int		read(lua_State *L, int index, int i1 = 0, int i2 = 0);
//	template<>	float				read(lua_State *L, int index, float f1 = 0.f, float f2 = 0.f);
//	template<>	double				read(lua_State *L, int index, double d1 = 0.0, double d2 = 0.0);
//	template<>	bool				read(lua_State *L, int index, char c1 = 0, char c2 = 0, char c3 = 0);
//	template<>	void				read(lua_State *L, int index, short s1 = 0, short s2 = 0, short s3 = 0);
//	template<>	__int64				read(lua_State *L, int index, long l1 = 0, long l2 = 0, long l3 = 0);
//	template<>	unsigned __int64	read(lua_State *L, int index, int i1 = 0, int i2 = 0, int i3 = 0);
//	template<>	table				read(lua_State *L, int index, long l1 = 0, long l2 = 0, long l3 = 0);
...
template<>
__int64 lua_tinker::read<__int64>(lua_State *L, int index)
{
...
template<>
unsigned __int64 lua_tinker::read<unsigned __int64>(lua_State *L, int index)
{
	if(lua_isnumber(L,index))
...
/*---------------------------------------------------------------------------*/ 
template<>
void lua_tinker::pop<void>(lua_State *L)
{
	lua_pop(L, 1);
}

template<>
lua_tinker::table lua_tinker::pop<lua_tinker::table>(lua_State *L)
{
