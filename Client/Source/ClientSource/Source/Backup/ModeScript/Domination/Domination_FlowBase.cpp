...
{
	//tinst<UIHUDDominationMgr>()->SetHudEvent( HUD_DOMI_SKILL, HUD_DMN_EVT_SKILL_SP_CHARGE, TRUE);
}

/*virtual*/ void CDominationFlowBase::EndFlow()
{
	//tinst<UIHUDDominationMgr>()->SetHudEvent( HUD_DOMI_SKILL, HUD_DMN_EVT_SKILL_SP_CHARGE, FALSE);
