...
I3_CLASS_INSTANCE( Crosshair_Dino_Raptor);//, Crosshair_Dino);

Crosshair_Dino_Raptor::Crosshair_Dino_Raptor(void)
{
}
...
void Crosshair_Dino_Raptor::Create(void)
{
	...
	m_pSprite->SetTextureCoord( 4, 715.0f, 396.0f, 715.0f + RAPTOR_SC_UP_CX, 396.0f+RAPTOR_SC_UP_CY);
	
}

void Crosshair_Dino_Raptor::_Update( REAL32 tm)
{
	REAL32 scrCX, scrCY;
	...
	m_pSprite->SetEnable( 4, m_bScratch == true);
