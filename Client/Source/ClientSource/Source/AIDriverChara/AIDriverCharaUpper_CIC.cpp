...
#include "AIDriverCharaUpper_CIC.h"
#include "../GameCharaAnimContext.h"

I3_CLASS_INSTANCE( AIDriverCharaUpper_CIC);//, i3AIDriver);

////////////////////////////////////////////////////////////////////////////////
//
// Move
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/Common/Move_AttackIdle.i3a
//
...
//
// Idle
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/Common/AttackIdle.i3a
//
...
//
// Attack
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/P99/Attack_Semi.i3a
//
...
//
// LoadBullet
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/P99/Reload.i3a
//
...
//
// DamageBackB
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/Common/Damage_AttackIdle.i3a
//
...
//
// JumpEnd
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/Common/JumpEnd_AttackIdle.i3a
//
...
//
// JumpStart
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/Common/JumpStart_AttackIdle.i3a
//
...
//
// Change
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/P99/Change.i3a
//
...
//
// AttackHak
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/P99/Attack_Hak.i3a
//
...
//
// AttackBurst
// ANIMATION : Chara/SWAT_Male/1ÀÎÄª/CIC/P99/Attack_Burst.i3a
//
...
////////////////////////////////////////////////////////////////////////////////
//
// SecondaryAttackBurst
// ANIMATION : Chara/SWAT_Male/3PV/CIC/Common/Up_Attack_Hak_Burst.i3a
//
static void AIPROC_SecondaryAttackBurst_Run( i3AIContext * pCtx, REAL32 tm)
{
	AIPROC_CHARA_ATTACK_RUN( pCtx, tm);
}

static void AIPROC_SecondaryAttackBurst_Fin( i3AIContext * pCtx, REAL32 tm)
{
	AIPROC_CHARA_ATTACK_FIN( pCtx, tm);
}
...
//
// UI_Idle_Change
// ANIMATION : Chara/SWAT_Male/3PV/CIC/UI/Idle_Change.i3a
//
...
//
// UI_Idle_Stand
// ANIMATION : Chara/SWAT_Male/3PV/CIC/UI/Idle_Stand.i3a
//
...
static i3::statictable::AISTATE_PROC s_CharaUpper_CICTable[] =
{
	...
	{	"SecondaryAttackBurst",	AIPROC_SecondaryAttackBurst_Run,	AIPROC_SecondaryAttackBurst_Fin	},
...
AIDriverCharaUpper_CIC::AIDriverCharaUpper_CIC(void)
{
	setAIProcTable( s_CharaUpper_CICTable, (sizeof(s_CharaUpper_CICTable)/sizeof(s_CharaUpper_CICTable[0])));
}
