#include "pch.h"
#include "AIDriverCharaUpper_CrossFire.h"
#include "GlobalVariables.h"
#include "GameCharaAnimContext.h"


I3_CLASS_INSTANCE( AIDriverCharaUpper_CrossFire);//, i3AIDriver);
...
//
// UI_Idle_Change
// ANIMATION : Chara/SWAT_Male/3PV/DualHandGun/UI/Idle_Change.i3a
//
...
//
// UI_Idle_Stand
// ANIMATION : Chara/SWAT_Male/3PV/DualHandGun/UI/Idle_Stand.i3a
//
...
static i3::statictable::AISTATE_PROC s_CharaUpper_CrossFireTable[] =
{
...
AIDriverCharaUpper_CrossFire::AIDriverCharaUpper_CrossFire(void)
{
	setAIProcTable( s_CharaUpper_CrossFireTable, (sizeof(s_CharaUpper_CrossFireTable)/sizeof(s_CharaUpper_CrossFireTable[0])));
}
