...
#include "AIDriverCharaUpper_RocketLauncher.h"
#include "../GameCharaAnimContext.h"

I3_CLASS_INSTANCE( AIDriverCharaUpper_RocketLauncher);//, i3AIDriver);
...
static i3::statictable::AISTATE_PROC s_CharaUpper_RocketLauncherTable[] =
{
...
AIDriverCharaUpper_RocketLauncher::AIDriverCharaUpper_RocketLauncher(void)
{
	setAIProcTable( s_CharaUpper_RocketLauncherTable, (sizeof(s_CharaUpper_RocketLauncherTable)/sizeof(s_CharaUpper_RocketLauncherTable[0])));
}
