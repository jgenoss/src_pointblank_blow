/**
 * \file	UI\UIPhaseLobby.h
 *
 * Declares the user interface phase lobby class.
 */


#if !defined( __UI_PHASE_LOBBY_H__)
#define __UI_PHASE_LOBBY_H__
...
{
	ULB_NONE = -1,
	ULB_QUICKJOIN,		// 빠른 입장 버튼
	ULB_CREATEROOM,		// 방생성 버튼
	ULB_ENTERROOM,		// 입장가능 버튼
	ULB_TUTORIAL,		// 튜토리얼 버튼
...
class UIPhaseLobby : public UIPhaseBase
{
	I3_CLASS_DEFINE( UIPhaseLobby, UIPhaseBase);
...
public:
	...
	static void		CbMercPenalty(void *pThis, INT32 nParam);
...
private:
	typedef void	(UIPhaseLobby::*call_func)(INT32, const i3::user_data&);
