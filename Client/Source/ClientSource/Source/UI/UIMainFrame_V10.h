#if !defined( __UI_MAINFRAME_V10_H__)
#define __UI_MAINFRAME_V10_H__
#include "UIMainFrame.h"

class UIMainFrame_V10 : public UIMainFrame
{
	I3_CLASS_DEFINE( UIMainFrame_V10, UIMainFrame);


	UIMainFrame_V10();
	virtual ~UIMainFrame_V10();
