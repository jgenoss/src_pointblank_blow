// PBConfig.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// 유일한 CPBConfigApp 개체입니다.

CPBConfigApp theApp;

BEGIN_MESSAGE_MAP(CPBConfigApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


CPBConfigApp::CPBConfigApp()
...
BOOL CPBConfigApp::InitInstance()
{
