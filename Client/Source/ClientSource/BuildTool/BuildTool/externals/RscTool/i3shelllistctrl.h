...
class i3ShellTreeCtrl;

/////////////////////////////////////////////////////////////////////////////
// i3ShellListCtrl window

class i3ShellListCtrl : public i3MFCListCtrl
{
	friend class i3ShellTreeCtrl;

	DECLARE_DYNAMIC(i3ShellListCtrl)
...
public:
	...
	void SetShowFolderOnly(bool b);
	bool IsShowFolderOnly() const;
...
public:
	...
	BOOL IsItemFolder(int iItem) const;
...
// Implementation
public:
	virtual ~i3ShellListCtrl();

protected:
	//{{AFX_MSG(i3ShellListCtrl)
	...
	BOOL InitList();
	i3ShellTreeCtrl* GetRelatedTree() const;
};

extern UINT I3_WM_CHANGE_CURRENT_FOLDER;
