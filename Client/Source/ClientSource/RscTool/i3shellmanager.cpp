...
//i3ShellManager* i3ShellManager::i() = NULL;

UINT I3_WM_ON_AFTER_SHELL_COMMAND = ::RegisterWindowMessage(_T("I3_WM_ON_AFTER_SHELL_COMMAND"));
...
bool IsEqualPidl(LPCITEMIDLIST aPidl1, LPCITEMIDLIST aPidl2)
{
	...
	UINT size_1 = i3ShellManager::i()->GetItemSize(aPidl1);
	UINT size_2 = i3ShellManager::i()->GetItemSize(aPidl2);

	if (size_1 != size_2)
		return false;
    
	return 0 ==  memcmp(aPidl1, aPidl2, size_1);;
}
...
int CALLBACK i3ShellManager::BrowseCallbackProc(HWND hwnd, UINT uMsg, LPARAM /*lParam*/, LPARAM lpData)
{
	if (uMsg == BFFM_INITIALIZED)
	{
		i3ShellManager* pThis = (i3ShellManager*) lpData;
		ASSERT_VALID(pThis);
...
BOOL i3ShellManager::BrowseForFolder(CString& strFolder, CWnd* pWndParent/* = NULL*/, LPCTSTR lplszInitialFolder/* = NULL*/,
...
LPITEMIDLIST i3ShellManager::GetNextItem(LPCITEMIDLIST pidl)
{
	if (pidl == NULL)
	{
		return NULL;
...
LPITEMIDLIST i3ShellManager::CreateItem(UINT cbSize)
{
...
UINT i3ShellManager::GetItemCount(LPCITEMIDLIST pidl)
{
	if (pidl == NULL)
	{
		return 0;
...
UINT i3ShellManager::GetItemSize(LPCITEMIDLIST pidl)
{
	UINT cbTotal = 0;
...
LPITEMIDLIST i3ShellManager::ConcatenateItem(LPCITEMIDLIST pidl1, LPCITEMIDLIST pidl2)
{
	UINT cb1 = 0;
...
LPITEMIDLIST i3ShellManager::CopyItem(LPCITEMIDLIST pidlSource)
{
	ENSURE(m_pMalloc != NULL);
...
void i3ShellManager::FreeItem(LPITEMIDLIST pidl)
{
	ENSURE(m_pMalloc != NULL);
...
HRESULT i3ShellManager::ItemFromPath(LPCTSTR lpszPath, LPITEMIDLIST& pidl)
{
...
int i3ShellManager::GetParentItem(LPCITEMIDLIST lpidl, LPITEMIDLIST& lpidlParent)
{
