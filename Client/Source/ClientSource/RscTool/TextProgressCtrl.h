...
// 원본 링크 : http://www.codeproject.com/Articles/80/Progress-Control-with-Text

// 현재 MFC와 호환되지 않는 코드들이 다소 있어....cpp 수정을 좀했다...(2014.02.26.수빈)
// 
...
class CTextProgressCtrl : public CProgressCtrl
{
	...
	public:
		...
		// 함수 추가...퍼세티지와 텍스트의 순서 조절해야함...
		void		SetShowPercentFirst(BOOL b) { m_bShowPercentFirst = b; }
		BOOL		IsShowPercentFirst() const { return m_bShowPercentFirst; }
	...
	protected:
		...
		BOOL		m_bShowPercentFirst;		// 추가 변수...퍼센트 텍스트가 위치한 순서 조절..
