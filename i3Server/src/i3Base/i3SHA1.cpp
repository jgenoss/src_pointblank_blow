 ...
 */
I3_EXPORT_BASE 
I3_SHA_RESULT i3SHA1::Reset( SHA1Context *context)
{
	I3ASSERT( context != NULL);
 ...
 */
I3_EXPORT_BASE
I3_SHA_RESULT i3SHA1::Result( SHA1Context *context, UINT8 Message_Digest[SHA1HashSize])
{
    INT32 i;
 ...
 */
I3_EXPORT_BASE
I3_SHA_RESULT i3SHA1::Input(    SHA1Context    *context, const UINT8  *message_array, UINT32 length)
{
    if (!length)
    {
        return shaSuccess;
    ...
    while(length-- && !(context->Corrupted != shaSuccess))
    {
...
long INT32 repeatcount[4] = { 1, 1, 1000000, 10 };
char *resultarray[4] =
{
