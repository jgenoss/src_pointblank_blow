...
namespace i3System
{
	...
	// 작성자		: 이진균
	// 작성일자		: 1999.6.1
	I3_EXPORT_BASE BOOL IsDirectory( const char* strPath );
	I3_EXPORT_BASE BOOL IsDirectory( const wchar_t* wstrPath );

	I3_EXPORT_BASE BOOL	IsFile( const char * pszPath);
	I3_EXPORT_BASE BOOL	GetRealFilename( const char * pszPath, char * pszName);

	I3_EXPORT_BASE BOOL	GetDrive( const char* strPath, char* strDrive, INT32 i32OutSize );
	I3_EXPORT_BASE BOOL	GetDrive( const wchar_t* wstrPath, wchar_t* wstrDrive, INT32 i32OutSize );
	///////////////////////////////////////////////////////////////
	...
	// 작성자		: 이진균
	// 작성일자		: 1999.6.1	
	I3_EXPORT_BASE BOOL PrepareDirectory( char *strPath );
	I3_EXPORT_BASE BOOL PrepareDirectory( wchar_t* wstrPath );
	...
	/** \brief 현재 디렉토리를 뽑아낸다. 
		...
		\param pathLen 경로 길이
		\return none	*/
	I3_EXPORT_BASE void GetCurrentPath( char * pszPath, INT32 pathLen );
