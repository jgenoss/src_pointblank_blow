...
namespace i3String
{
	...
	I3_EXPORT_BASE void MakePointFix( REAL64 Value, wchar_t *Result, INT32 UnderCount, bool FillZero);
	...
	I3_EXPORT_BASE INT32 Compare( const wchar_t* str1, const wchar_t* str2);
	...
	I3_EXPORT_BASE void Copy( wchar_t * pDest, const wchar_t * pSrc, INT32 DestLength);
	...
	I3_EXPORT_BASE INT32 Length( const wchar_t * pStr );
	...
	// 앞에서 부터 찾는다.
	// 없으면 -1 반환
	I3_EXPORT_BASE INT32 ContainChar( const wchar_t * pStr, wchar_t ch );
	...
	I3_EXPORT_BASE void Concat( wchar_t * pDest, const wchar_t * pSrc); 
	...
	I3_EXPORT_BASE INT32 Format( char * strDest, INT32 i32Length, const char * strFormat, ...);
	I3_EXPORT_BASE INT32 Format( wchar_t * strDest, INT32 i32Length, const wchar_t * strFormat, ...);
