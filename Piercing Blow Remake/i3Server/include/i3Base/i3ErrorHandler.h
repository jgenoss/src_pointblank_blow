...
namespace i3Error
{
	...
	I3_EXPORT_BASE void SetExceptionHandler( const char* pszDmpFileName = NULL );
...
#define I3PRINTLOG(logtype, fmt, ...) \
	i3Error::SetEnv( __FILE__, __LINE__, __FUNCSIG__, logtype);\
...
#define			I3ERRLOG_MSG( code, msg)	{ I3WARN( "%s (%s)", i3Error::getMsg((code)), (msg));	}
#define			I3ERRLOG( code)				{ I3WARN( "%s", i3Error::getMsg((code)));	}
