...
enum Protocol_Base
{
	...
	PROTOCOL_BASE_EVENT_ITEM_ACK,							// 선물함 기능이 꺼져 있을떄 인벤에 들어갔다는 것을 알려줍니다.};
...
enum Protocol_Shop
{
	...
	PROTOCOL_AUTH_GET_POINT_CASH_REQ,				// 자신의 포인트와 캐쉬 정보 요청
	PROTOCOL_AUTH_GET_POINT_CASH_ACK,				// 자신의 포인트와 캐쉬 정보 응답
